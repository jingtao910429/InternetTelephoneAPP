package net.internetTelephone.program.project.detail.readme;
...
import net.internetTelephone.program.model.Depot;
import net.internetTelephone.program.model.ProjectObject;
import net.internetTelephone.program.project.detail.merge.ReadmeEditActivity;
import net.internetTelephone.program.project.detail.merge.ReadmeEditActivity_;
