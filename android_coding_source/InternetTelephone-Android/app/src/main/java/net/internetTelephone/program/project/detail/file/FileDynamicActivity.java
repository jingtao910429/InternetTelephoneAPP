package net.internetTelephone.program.project.detail.file;
...
import net.internetTelephone.program.project.detail.merge.CommentActivity;
import net.internetTelephone.program.project.detail.merge.CommentActivity_;
import net.internetTelephone.program.task.add.CommentHolder;
import net.internetTelephone.program.task.add.TaskListHolder;
