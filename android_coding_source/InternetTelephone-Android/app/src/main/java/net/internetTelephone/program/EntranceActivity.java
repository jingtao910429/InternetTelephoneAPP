...
import net.internetTelephone.program.login.ResetPasswordActivity_;
import net.internetTelephone.program.login.UserActiveActivity_;
...
//                    startActivity(mainIntent);
                    ...
                    resultIntent.setPackage("net.internetTelephone.program");
