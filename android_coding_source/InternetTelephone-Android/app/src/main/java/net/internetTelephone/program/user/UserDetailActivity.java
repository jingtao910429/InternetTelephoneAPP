package net.internetTelephone.program.user;
...
import net.internetTelephone.program.UserDetailEditActivity_;
...
import net.internetTelephone.program.project.detail.file.LocalProjectFileActivity_;
