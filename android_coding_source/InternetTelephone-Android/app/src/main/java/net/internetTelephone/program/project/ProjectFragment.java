...
import net.internetTelephone.program.common.widget.NoHorizontalScrollViewPager;
import net.internetTelephone.program.event.EventPosition;
import net.internetTelephone.program.event.EventRefresh;
import net.internetTelephone.program.maopao.MaopaoAddActivity_;
import net.internetTelephone.program.model.AccountInfo;
import net.internetTelephone.program.model.ProjectObject;
import net.internetTelephone.program.project.init.create.ProjectCreateActivity_;
import net.internetTelephone.program.search.SearchProjectActivity_;
import net.internetTelephone.program.task.add.TaskAddActivity_;
import net.internetTelephone.program.user.AddFollowActivity_;
...
public class ProjectFragment extends BaseFragment implements ViewPager.OnPageChangeListener, ProjectListFragment.UpdateData, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String RECEIVER_INTENT_REFRESH_PROJECT = "net.internetTelephone.program.project.receiver.refresh";
