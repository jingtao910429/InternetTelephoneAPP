...
import net.internetTelephone.program.common.PushReceiver;
...
public class MyPushReceiver extends BroadcastReceiver {
    ...
    public static final String PushClickBroadcast = "net.internetTelephone.program.MyPushReceiver.PushClickBroadcast";
