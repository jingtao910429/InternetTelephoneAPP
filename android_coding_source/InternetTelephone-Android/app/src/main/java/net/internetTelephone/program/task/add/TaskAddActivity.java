...
import net.internetTelephone.program.DensityUtil;
...
import net.internetTelephone.program.common.CommentBackup;
import net.internetTelephone.program.common.DatePickerFragment;
...
import net.internetTelephone.program.common.enter.ImageCommentLayout;
import net.internetTelephone.program.common.enter.SimpleTextWatcher;
...
import net.internetTelephone.program.model.RefResourceObject;
...
import net.internetTelephone.program.project.detail.TaskListFragment;
import net.internetTelephone.program.project.detail.TopicAddActivity;
import net.internetTelephone.program.project.detail.TopicLabelActivity;
import net.internetTelephone.program.project.detail.TopicLabelActivity_;
import net.internetTelephone.program.project.detail.TopicLabelBar;
import net.internetTelephone.program.task.TaskDescriptionActivity_;
...
import static net.internetTelephone.program.common.util.LogUtils.makeLogTag;
