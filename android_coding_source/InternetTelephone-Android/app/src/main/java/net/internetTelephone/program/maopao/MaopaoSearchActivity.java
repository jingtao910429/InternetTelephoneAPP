...
import net.internetTelephone.program.common.SearchCache;
...
import net.internetTelephone.program.subject.SubjectSearchFragment_;
import net.internetTelephone.program.subject.adapter.SubjectSearchHistoryListAdapter;
