...
import net.internetTelephone.program.model.NotifyObject;
...
//          这种情况做特殊处理。  早上好，今天您有3个任务已超期
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(net.internetTelephone.program.R.menu.notify_list_activity, menu);
...
//            return true;
//        }
//        if (itemId_ == net.internetTelephone.program.R.id.markRead) {
//            markRead();
//            return true;
//        }
