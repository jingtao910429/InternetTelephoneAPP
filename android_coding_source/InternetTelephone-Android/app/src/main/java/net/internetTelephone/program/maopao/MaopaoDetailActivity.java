...
import net.internetTelephone.program.common.comment.HtmlCommentHolder;
...
import net.internetTelephone.program.maopao.item.MaopaoLikeAnimation;
...
//            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case net.internetTelephone.program.R.id.action_copy:
                action_copy();
                return true;
...
//    private UMSocialService mController = UMServiceFactory.getUMSocialService("net.internetTelephone.program");
