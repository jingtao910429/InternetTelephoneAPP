...
import net.internetTelephone.program.common.SearchProjectCache;
import net.internetTelephone.program.common.adapter.SearchHistoryListAdapter;
...
public class SearchProjectActivity extends BaseActivity implements TextView.OnEditorActionListener, TextWatcher, View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    View emptyView;
    @ViewById
    net.internetTelephone.program.common.PagerSlidingTabStrip tabs;
    @ViewById(R.id.pager)
    ViewPager pager;
    // footer
