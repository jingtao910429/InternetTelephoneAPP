...
import net.internetTelephone.program.common.widget.FlowLabelLayout;
...
import net.internetTelephone.program.task.TaskListUpdate;
...
public class TaskListFragment extends RefreshBaseFragment implements TaskListUpdate {
    ...
    private net.internetTelephone.program.task.TaskListParentUpdate mParent;

    public void setParent(net.internetTelephone.program.task.TaskListParentUpdate parent) {
        mParent = parent;
    }
