package net.internetTelephone.program.third;/*
...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public MyPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        myFirstExtraPdddingLeft = getResources().getDimensionPixelSize(net.internetTelephone.program.R.dimen.my_pager_sliding_tab_strip_first_padding_left);

        myPaddingLeft = getResources().getDimensionPixelSize(net.internetTelephone.program.R.dimen.my_pager_sliding_tab_strip);
        myPaddingLeft = 0;
...
//
//		addTab(position, tab);
        View v = mInflater.inflate(net.internetTelephone.program.R.layout.imageview_head, null, false);
        ImageView head = (ImageView) v.findViewById(net.internetTelephone.program.R.id.head);
        if (url.isEmpty()) {
            head.setImageResource(net.internetTelephone.program.R.drawable.icon_all_task);
...
//        if (position == 0) {
//            View v = tab.findViewById(net.internetTelephone.program.R.id.layout);
