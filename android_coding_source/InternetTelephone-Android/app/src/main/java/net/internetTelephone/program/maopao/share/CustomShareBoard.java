...
package net.internetTelephone.program.maopao.share;
...
import net.internetTelephone.program.AllThirdKeys;
...
import net.internetTelephone.program.common.widget.IconTextView;
...
public class CustomShareBoard extends PopupWindow implements OnClickListener {
    ...
    private static UMSocialService mController = UMServiceFactory.getUMSocialService("net.internetTelephone.program");
