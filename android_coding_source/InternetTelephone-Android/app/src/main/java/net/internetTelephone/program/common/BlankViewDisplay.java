...
import net.internetTelephone.program.message.MessageListActivity;
import net.internetTelephone.program.message.UsersListFragment;
import net.internetTelephone.program.project.ProjectListFragment;
import net.internetTelephone.program.project.detail.AttachmentsActivity;
import net.internetTelephone.program.project.detail.AttachmentsDownloadDetailActivity;
import net.internetTelephone.program.project.detail.AttachmentsHtmlDetailActivity;
import net.internetTelephone.program.project.detail.AttachmentsTextDetailActivity;
import net.internetTelephone.program.project.detail.ProjectDynamicFragment;
...
import net.internetTelephone.program.project.detail.TopicListFragment;
import net.internetTelephone.program.project.detail.merge.MergeListFragment;
import net.internetTelephone.program.project.detail.merge.MergeReviewerListFragment;
import net.internetTelephone.program.user.UserProjectListFragment;
