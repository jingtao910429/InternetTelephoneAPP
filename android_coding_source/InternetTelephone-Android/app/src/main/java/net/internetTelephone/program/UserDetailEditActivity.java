...
import net.internetTelephone.program.common.photopick.CameraPhotoUtil;
...
import net.internetTelephone.program.user.ProvincesPickerDialog;
import net.internetTelephone.program.user.SetUserInfoActivity_;
import net.internetTelephone.program.user.SetUserTagActivity_;
import net.internetTelephone.program.user.UserProvincesDialogFragment;
